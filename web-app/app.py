...
def upload_audio():
    ...
    is_right = "Correct!" if transcript == correct_answer else "Wrong!"  # pylint: disable=invalid-name
...
def give_hint():
    ...
    hint = 'the answer is less than 10!' if correct_answer in possible_answers else 'the answer is more than 10!'
